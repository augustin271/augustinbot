const ownerNumber = ["5515988385017@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '5515988385017' 
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=5515988385017:+55 15 98838-5017\n' 
+ 'END:VCARD'
